        ...
        html! {
            ...
            div class="card" {
                ...
                @if espo_indexed {
                    div class="pager" {
                        @if tx_has_prev {
                            a class="pill iconbtn" href=(format!("{}/block/{height}?tab=txs&page=1&limit={limit}&traces={traces_param}&hide_diesel_mints={hide_diesel_param}", base_path)) aria-label="First page" {
                                (icon_skip_left())
                            }
                        } @else {
                        ...
                        @if tx_has_prev {
                            a class="pill iconbtn" href=(format!("{}/block/{height}?tab=txs&page={}&limit={limit}&traces={traces_param}&hide_diesel_mints={hide_diesel_param}", base_path, page - 1)) aria-label="Previous page" {
                                (icon_left())
                            }
                        } @else {
                        ...
                        @if tx_has_next {
                            a class="pill iconbtn" href=(format!("{}/block/{height}?tab=txs&page={}&limit={limit}&traces={traces_param}&hide_diesel_mints={hide_diesel_param}", base_path, page + 1)) aria-label="Next page" {
                                (icon_right())
                            }
                        } @else {
                        ...
                        @if tx_has_next {
                            a class="pill iconbtn" href=(format!("{}/block/{height}?tab=txs&page={}&limit={limit}&traces={traces_param}&hide_diesel_mints={hide_diesel_param}", base_path, last_page)) aria-label="Last page" {
                                (icon_skip_right())
                            }
                        } @else {
